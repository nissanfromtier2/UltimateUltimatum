...
country = {
	...
	AI_SUPPORT_REFORM = 10000, -- At least this many % needs to support a reform for the AI to take it
	...
	RESEARCH_POINTS_ON_CONQUER_MULT = 3600, -- multiplier to RP got by conquering as unciv when got enacted military reforms
...
military = {
	...
	LEADER_AGE_DEATH_FACTOR = 40, -- higher value means leaders live longer
...
ai =
{
	...
	ADMINISTRATOR_WEIGHT = 0.5, -- ai weight for new bureaucrat
	...
	SOLDIER_FRACTION = 0.5, -- max amount of population AI wants to be soldiers
	CAPITALIST_FRACTION = 1, -- max amount of population AI wants to be capis
	...
	CHANCE_INVEST_POP_PROJ = 10,
	CHANCE_FOREIGN_INVEST = 10,
	...
	AGGRESSION_BASE = 200, -- general AI aggression
	...
	MIN_FLEETS = 100, -- Minimum amount of main fleets the AI will divide its navy into (does not include specialized fleets such as blockades and naval invasions)
	MAX_FLEETS = 1000, -- Maximal amount of main fleets the AI will divide its navy into (does not include specialized fleets such as blockades and naval invasions)
